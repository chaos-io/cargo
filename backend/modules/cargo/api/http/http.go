...
func RegisterHttpHandler(router *mux.Router, endpoints endpoint.Endpoints, tracer trace.Tracer, logger log.Logger) {
	...
	router.Methods("POST").Path("/cargo/v1/resources").Handler(
		httptransport.NewServer(
			endpoints.CreateResourceEndpoint,
			DecodeHTTPCreateResourceRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("CreateResource")...,
		))

	router.Methods("GET").Path("/cargo/v1/resources/{id}").Handler(
		httptransport.NewServer(
			endpoints.GetResourceEndpoint,
			DecodeHTTPGetResourceRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("GetResource")...,
		))

	router.Methods("GET").Path("/cargo/v1/resources").Handler(
		httptransport.NewServer(
			endpoints.ListResourcesEndpoint,
			DecodeHTTPListResourcesRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("ListResources")...,
		))

	router.Methods("PUT").Path("/cargo/v1/resources").Handler(
		httptransport.NewServer(
			endpoints.UpdateResourceEndpoint,
			DecodeHTTPUpdateResourceRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("UpdateResource")...,
		))

	router.Methods("DELETE").Path("/cargo/v1/resources/{id}").Handler(
		httptransport.NewServer(
			endpoints.DeleteResourceEndpoint,
			DecodeHTTPDeleteResourceRequest,
			EncodeHTTPGenericResponse,
...
// DecodeHTTPCreateResourceRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded createresource request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPCreateResourceRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.CreateResourceRequest
	...
	if req.Resource == nil {
		...
		req.Resource = &cargo.Resource{}
	}

	err = unmarshalQueryParam(queryParams, req.Resource, "resource")
	if err != nil {
		if core.IsNotFoundError(err) {
			...
			return nil, nhttp.WrapError(err, 400, "cannot unmarshal the resource query parameter")
		}
	}

	err = unmarshalQueryParam(queryParams, &req.Locale, "locale")
	if err != nil && !core.IsNotFoundError(err) {
		return nil, nhttp.WrapError(err, 400, "cannot unmarshal the locale query parameter")
	}

	return &req, nil
}

// DecodeHTTPGetResourceRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded getresource request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPGetResourceRequest(_ context.Context, r *http.Request) (interface{}, error) {
	...
	err = unmarshalPathParam(pathParams, &req.Id, "id")
	if err != nil && !core.IsNotFoundError(err) {
...
// DecodeHTTPListResourcesRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded listresources request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPListResourcesRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.ListResourcesRequest
...
// DecodeHTTPUpdateResourceRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded updateresource request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPUpdateResourceRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.UpdateResourceRequest
...
// DecodeHTTPDeleteResourceRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded deleteresource request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPDeleteResourceRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.DeleteResourceRequest
